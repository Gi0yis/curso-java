public class ComparacionCadenas {
    public static void main(String[] args) {
        ...
        // Compacion de cadena1 con cadena3 (referencias)
        System.out.print("cadena1 es igual en referencia a cadena3: ");
        System.out.println(cadena1 == cadena3);

        // Para comparar el contenido usaremos el metodo equals
        System.out.print("cadena uno es igual en contenido a cadena3: ");
